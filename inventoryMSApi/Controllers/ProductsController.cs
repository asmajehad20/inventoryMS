    ...
    public class ProductsController : ControllerBase
    {
        ...
        public IActionResult UpdateProduct([FromBody] Product product, string keyword)
        {
            ...
            if (InventoryManager.CheckIfProductExists(keyword))
            {
                ...
                string name = product.Name ?? existingProduct.Name;
                string barcode = product.Barcode ?? existingProduct.Barcode;
                ...
                string status = product.Status ?? existingProduct.Status;
                string category = product.CategoryName ?? existingProduct.CategoryName;
